...
// import Editor, {RichUtils} from 'draft-js-plugins-editor';
...
export default class Drafteditor extends Component {
  constructor(props) {
   ...
   onClickBack = () => {
     this.onChange()
     editorState = RichUtils.handleKeyCommand(editorState, 'backspace');
  ...
  render() {
    ...
    <div onClick={this.onClickEditor } onBlur={this.checkSelectedText}  class={styles.editor}>
     <div
      ref={(elem) => {
...
const styleMap = {
  CODE: {
    ...
    fontFamily: '"Times New Roman", "Menlo", "Consolas", monospace',
    fontSize: 16,
    padding: 4,
  },
  BOLD: {
...
var toolbarItems = [
  { label: '𝐁', style: 'BOLD' },
  { label: '𝑰', style: 'ITALIC' },
  { label: '𝑼̲', style: 'UNDERLINE' },
  { label: '</>', style: 'CODE' },
  { label: 'Styled', style: 'ANYCUSTOMSTYLE' },
]
  ...
  blocks: [
    {
      ...
      type: 'unstyled',
      depth: 0,
      inlineStyleRanges: [{ offset: 0, length: 23, style: 'NORMAL' }],
      entityRanges: [],
      data: {},
    }
  ],
